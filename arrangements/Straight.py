...
class Straight(HelperArrangement):
    ...
    def __init__(self):
        ...
        if self.max_value_generate < 100:
            ...
            n_loading_bar = 100
        self.loading_bar:LoadingBar = LoadingBar('straight', self.max_value_generate, n_loading_bar, n_loading_bar, self.helper_arr)
        self.loading_bar_combs:LoadingBar = LoadingBar('straight_combs', self.max_value_generate, n_loading_bar, n_loading_bar, self.helper_arr)
