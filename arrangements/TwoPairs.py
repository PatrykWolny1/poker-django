...
class TwoPairs(HelperArrangement):
    ...
    def init_loading_bar(self, session_id):
        ...
        self.loading_bar:LoadingBar = LoadingBar('twopairs', self.max_value_generate, n_loading_bar, n_loading_bar, self.helper_arr)
        self.loading_bar_combs:LoadingBar = LoadingBar('twopairs_combs', self.max_value_generate, n_loading_bar, n_loading_bar, self.helper_arr)
    ...
    def two_pairs_generating(self, random, if_combs, session_id):
        self.random = random
