...
class MyThread(threading.Thread):
    def __init__(self, target, data_queue=None, flag1=None, flag2=None, session_id=None, stop_event=None, stop_event_progress=None):
        ...
        self.stop_event_progress = stop_event_progress
        self.daemon = True
